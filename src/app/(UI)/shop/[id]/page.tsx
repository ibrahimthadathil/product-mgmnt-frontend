...
//     }
//     try {
//       // Add product to cart with quantity (if backend supports it, otherwise add multiple times)
...
//           {/* Main Image Preview */}
//           <div className="flex-1 relative aspect-square bg-white rounded-lg overflow-hidden shadow-lg">
